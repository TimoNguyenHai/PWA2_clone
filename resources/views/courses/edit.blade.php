...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">{{ __('courses.update') }}
        </div>
        
        <div class="card-body">
          
          {!! Form::model($courses, ['route' => ['courses.update', $courses->id], 'method' => 'PUT']) !!}

          <div class="row">
            <div class="col-sm-12">
              @include('templates.form-text', ['space' => 'courses', 'tag' => 'name', 'list' => $listCourses])
            </div>
          </div>
